...
inline constexpr uint32_t k_can_id_nv_memory = 0x140U;
...
inline constexpr uint32_t k_error_nv_memory = 1UL << 10U;
...
struct SmokeContext {
  SmokeContext() noexcept
      : led{ru::driver::GpioId::LED_E3},
        ...
        nv_memory{ru::driver::NvMemoryId::BOOT_COUNTER} {}
